...
// int n1 = wsDecodeFrame((char*)hexData, outstring, sizeof(hexData), bfullpack);
  ...
  // Size    : 49 (0x31)
  //------------------------------------------------------------
  //unsigned char hexData[49] =
  //{
  //  0x68, 0xA6, 0x00, 0xA6, 0x00, 0x68, 0xC4, 0x01, 0x18, 0x13, 0x04, 0x04, 0x0E, 0x64, 0x00, 0x00,
  //  0x01, 0x00, 0x34, 0x1B, 0x48, 0x06, 0x03, 0x12, 0x18, 0x05, 0x00, 0x37, 0x00, 0x00, 0x00, 0x38,
  //  0x00, 0x00, 0x00, 0x39, 0x00, 0x00, 0x00, 0x3A, 0x00, 0x20, 0x00, 0x3B, 0x00, 0x00, 0x00, 0x77,
  //  0x16
  //};
  //IOCP_IO_PTR p1;
