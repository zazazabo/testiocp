...
// m_pData = static_cast<CEditUI*>(m_pm.FindControl(_T("data")));
    ...
    m_lbgaywayNum = static_cast<CLabelUI*>(m_pm.FindControl(_T("gaywaynum")));
    m_lbWebNum = static_cast<CLabelUI*>(m_pm.FindControl(_T("webnum")));
    m_lbgaywayNum->SetText("0");
    m_lbWebNum->SetText("0");
...
// m_pData->SetText("683200320068040217010102ac71000020046216");
	...
	int emailport=atoi(mailport.c_str());
