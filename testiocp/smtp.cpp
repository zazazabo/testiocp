...
)
{
  ...
  if(m_vectorTargetEamil.find(targetEmail) == m_vectorTargetEamil.end())
    {
      m_vectorTargetEamil.insert(pair<string, int>(targetEmail, 1));
    }

  // m_vectorTargetEamil.push_back(targetEmail);
}
...
{
  if(m_vectorTargetEamil.find(strTargetEmail) == m_vectorTargetEamil.end())
    {
      m_vectorTargetEamil.insert(pair<string, int>(strTargetEmail, 1));
    }
